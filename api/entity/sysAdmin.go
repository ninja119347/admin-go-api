...
type SysAdmin struct {
	ID         uint       `json:"id" gorm:"column:id;comment:'主键'" `
	...
	Nickname   string     `json:"nickname" gorm:"column:nickname;varchar(64);comment:'昵称';NOT NULL" `
	Status     int        `json:"status" gorm:"column:status;default:1;comment:'状态:1->on;2->of';NOT NULL" `
